...
<p align="center">
  ...
  <img alt="Version 1.4.0" src="https://img.shields.io/badge/version-1.4.0-2f6fe4">
</p>
...
- 支持配置面板失焦后自动收起为悬浮球
- Cookie 或 Token 失效时通过系统托盘提醒更新凭据
...
前往 [GitHub Releases](https://github.com/chenyifei142/TokenSpider/releases/tag/v1.4.0) 下载 Windows 便携版：

- `TokenSpider-v1.4.0-windows-x64.exe`
...
- 新增「点击面板外部时自动收起」设置项，默认开启；可按使用习惯关闭。
