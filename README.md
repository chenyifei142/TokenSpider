...
<p align="center">
  ...
  <img alt="Version 1.3.0" src="https://img.shields.io/badge/version-1.3.0-2f6fe4">
</p>
...
前往 [GitHub Releases](https://github.com/chenyifei142/TokenScope/releases/tag/v1.3.0) 下载 Windows 便携版：

- `TokenScope-v1.3.0-windows-x64.exe`
...
- 新增独立更新器 `TokenScopeUpdater.exe`，主程序下载并校验完成后由更新器等待旧进程退出、备份、替换并重启新版。
- 新增 GitHub Actions 发布工作流与发布脚本，自动构建 `TokenScope.exe`、`TokenScopeUpdater.exe`、`SHA256SUMS.txt` 并上传到 GitHub Release。
